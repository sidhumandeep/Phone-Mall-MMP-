    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price"> £149.99 <span>£299.99</span> </div>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>new printer</h3>
                <div class="price"> £199.99 <span>£299.99</span> </div>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>new speakers</h3>
                <div class="price"> £49.99 <span>£199.99</span> </div>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
